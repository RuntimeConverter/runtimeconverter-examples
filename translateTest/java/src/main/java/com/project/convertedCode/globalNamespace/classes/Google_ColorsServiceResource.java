...
import com.project.convertedCode.globalNamespace.classes.Google_Colors;
...
public class Google_ColorsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_ColorsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object get(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_ColorsServiceResource.class,
                        "get",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_ColorsServiceResource.class))) {
            return ZVal.assign(new Google_Colors(env, data));
