...
public class Google_CommentAuthorImage extends Google_Model implements RuntimeFileContextInterface {

    public Object url = null;

    public Google_CommentAuthorImage(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setUrl(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_CommentAuthorImage.class, "url", url);

        return null;
    }

    public Object getUrl(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CommentAuthorImage.class, "url"));
    }
