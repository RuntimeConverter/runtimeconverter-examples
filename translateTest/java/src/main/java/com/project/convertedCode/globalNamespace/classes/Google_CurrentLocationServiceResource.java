...
public class Google_CurrentLocationServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_CurrentLocationServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_CurrentLocationServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_CurrentLocationServiceResource.class))) {
