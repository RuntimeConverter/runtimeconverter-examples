...
public class Google_SiteVerificationWebResourceListResponse extends Google_Model
        implements RuntimeFileContextInterface {

    public Object __itemsType = "Google_SiteVerificationWebResourceResource";

    public Object __itemsDataType = "array";

    public Object items = null;

    public Google_SiteVerificationWebResourceListResponse(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "__itemsType":
                if (Google_SiteVerificationWebResourceListResponse.class.isAssignableFrom(caller)) {
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_SiteVerificationWebResourceListResponse.class,
                items,
                "Google_SiteVerificationWebResourceResource",
                "setItems");
        ZVal.setProperty(
                this, Google_SiteVerificationWebResourceListResponse.class, "items", items);
    ...
    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(
                        this, Google_SiteVerificationWebResourceListResponse.class, "items"));
    }
