...
import com.project.convertedCode.globalNamespace.classes.Google_Profile;
...
public class Google_ProfilesServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_ProfilesServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object patch(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_ProfilesServiceResource.class,
                        "patch",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_ProfilesServiceResource.class))) {
            return ZVal.assign(new Google_Profile(env, data));
