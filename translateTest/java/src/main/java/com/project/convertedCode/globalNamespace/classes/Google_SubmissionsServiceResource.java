...
public class Google_SubmissionsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_SubmissionsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_SubmissionsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_SubmissionsServiceResource.class))) {
