...
public class Google_GaDataQuery extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_GaDataQuery(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setMax_results(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_GaDataQuery.class, "max_results", max_results);

        return null;
    }

    public Object getMax_results(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "max_results"));
    }

    public Object setSort(RuntimeEnv env, Object... args) {
        Object sort = ZVal.assignParameter(args, 0, null);
        env.callMethod(
                this, "assertIsArray", Google_GaDataQuery.class, sort, "Google_string", "setSort");
        ZVal.setProperty(this, Google_GaDataQuery.class, "sort", sort);

        return null;
    }

    public Object getSort(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "sort"));
    }

    public Object setDimensions(RuntimeEnv env, Object... args) {
        Object dimensions = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_GaDataQuery.class, "dimensions", dimensions);

        return null;
    }

    public Object getDimensions(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "dimensions"));
    }

    public Object setStart_date(RuntimeEnv env, Object... args) {
        Object start_date = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_GaDataQuery.class, "start_date", start_date);

        return null;
    }

    public Object getStart_date(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "start_date"));
    }

    public Object setStart_index(RuntimeEnv env, Object... args) {
        Object start_index = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_GaDataQuery.class, "start_index", start_index);

        return null;
    }

    public Object getStart_index(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "start_index"));
    }

    public Object setSegment(RuntimeEnv env, Object... args) {
        Object segment = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_GaDataQuery.class, "segment", segment);

        return null;
    }

    public Object getSegment(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "segment"));
    }

    public Object setIds(RuntimeEnv env, Object... args) {
        Object ids = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_GaDataQuery.class, "ids", ids);

        return null;
    }

    public Object getIds(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "ids"));
    }
    ...
    public Object setMetrics(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_GaDataQuery.class,
                metrics,
                "Google_string",
                "setMetrics");
        ZVal.setProperty(this, Google_GaDataQuery.class, "metrics", metrics);

        return null;
    }

    public Object getMetrics(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "metrics"));
    }

    public Object setFilters(RuntimeEnv env, Object... args) {
        Object filters = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_GaDataQuery.class, "filters", filters);

        return null;
    }

    public Object getFilters(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "filters"));
    }

    public Object setEnd_date(RuntimeEnv env, Object... args) {
        Object end_date = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_GaDataQuery.class, "end_date", end_date);

        return null;
    }

    public Object getEnd_date(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_GaDataQuery.class, "end_date"));
    }
