...
import com.project.convertedCode.globalNamespace.classes.Google_SubmissionList;
import com.runtimeconverter.runtime.modules.standard.CRArrayF;
import com.runtimeconverter.runtime.classes.RuntimeClassBase;
import com.runtimeconverter.runtime.RuntimeEnv;
import com.project.convertedCode.globalNamespace.classes.Google_Submission;
...
public class Google_ResponsesServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_ResponsesServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listResponses":
                return this.listResponses(env, args);
        }
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        Object parentSubmissionId = ZVal.assignParameter(args, 2, null);
        ...
        params =
                ZVal.newArray(
                        ...
                        new ZPair("parentSubmissionId", parentSubmissionId),
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_ResponsesServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_ResponsesServiceResource.class))) {
            return ZVal.assign(new Google_Submission(env, data));
    ...
    public Object listResponses(RuntimeEnv env, Object... args) {
        Object seriesId = ZVal.assignParameter(args, 0, null);
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_ResponsesServiceResource.class))) {
            return ZVal.assign(new Google_SubmissionList(env, data));
