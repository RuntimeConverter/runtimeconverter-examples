...
public class Google_SeriesId extends Google_Model implements RuntimeFileContextInterface {

    public Object seriesId = null;

    public Google_SeriesId(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setSeriesId(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_SeriesId.class, "seriesId", seriesId);

        return null;
    }

    public Object getSeriesId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SeriesId.class, "seriesId"));
    }
