...
public class Google_Annotationsdata extends Google_Model implements RuntimeFileContextInterface {

    public Object nextPageToken = null;

    public Object __itemsType = "Google_Annotationdata";
    ...
    public Google_Annotationsdata(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            ...
            case "__itemsType":
                if (Google_Annotationsdata.class.isAssignableFrom(caller)) {
    ...
    public Object setNextPageToken(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_Annotationsdata.class, "nextPageToken", nextPageToken);

        return null;
    }

    public Object getNextPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Annotationsdata.class, "nextPageToken"));
    }
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_Annotationsdata.class,
                items,
                "Google_Annotationdata",
                "setItems");
        ZVal.setProperty(this, Google_Annotationsdata.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Annotationsdata.class, "items"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Annotationsdata.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Annotationsdata.class, "kind"));
    }

    public Object setTotalItems(RuntimeEnv env, Object... args) {
        Object totalItems = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Annotationsdata.class, "totalItems", totalItems);

        return null;
    }

    public Object getTotalItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Annotationsdata.class, "totalItems"));
    }
