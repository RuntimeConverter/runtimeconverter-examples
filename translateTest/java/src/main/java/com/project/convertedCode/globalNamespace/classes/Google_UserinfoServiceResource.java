...
public class Google_UserinfoServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_UserinfoServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object get(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_UserinfoServiceResource.class,
                        "get",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_UserinfoServiceResource.class))) {
