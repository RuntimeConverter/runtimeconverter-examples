...
public class Google_BlogList extends Google_Model implements RuntimeFileContextInterface {

    public Object __itemsType = "Google_Blog";
    ...
    public Google_BlogList(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "__itemsType":
                if (Google_BlogList.class.isAssignableFrom(caller)) {
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this, "assertIsArray", Google_BlogList.class, items, "Google_Blog", "setItems");
        ZVal.setProperty(this, Google_BlogList.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BlogList.class, "items"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_BlogList.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BlogList.class, "kind"));
    }
