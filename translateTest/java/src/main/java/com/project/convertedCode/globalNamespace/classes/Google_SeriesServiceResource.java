...
import com.project.convertedCode.globalNamespace.classes.Google_Series;
import com.runtimeconverter.runtime.passByReference.PassByReferenceArgs;
import com.runtimeconverter.runtime.includes.RuntimeFileContextInterface;
import com.project.convertedCode.globalNamespace.classes.Google_SeriesList;
...
public class Google_SeriesServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_SeriesServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listSeries":
                return this.listSeries(env, args);
            case "update":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_SeriesServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_SeriesServiceResource.class))) {
            return ZVal.assign(new Google_Series(env, data));
    ...
    public Object listSeries(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        ...
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_SeriesServiceResource.class))) {
            return ZVal.assign(new Google_SeriesList(env, data));
