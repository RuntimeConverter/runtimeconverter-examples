...
public class Google_PageAuthorImage extends Google_Model implements RuntimeFileContextInterface {

    public Object url = null;

    public Google_PageAuthorImage(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setUrl(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_PageAuthorImage.class, "url", url);

        return null;
    }

    public Object getUrl(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_PageAuthorImage.class, "url"));
    }
