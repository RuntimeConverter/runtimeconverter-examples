...
public class Google_PlaylistItem extends Google_Model implements RuntimeFileContextInterface {

    public Object __snippetType = "Google_PlaylistItemSnippet";
    ...
    public Google_PlaylistItem(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "__snippetType":
                if (Google_PlaylistItem.class.isAssignableFrom(caller)) {
    ...
    public Object setSnippet(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_PlaylistItem.class, "snippet", snippet);

        return null;
    }

    public Object getSnippet(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_PlaylistItem.class, "snippet"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_PlaylistItem.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_PlaylistItem.class, "kind"));
    }

    public Object setEtag(RuntimeEnv env, Object... args) {
        Object etag = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_PlaylistItem.class, "etag", etag);

        return null;
    }

    public Object getEtag(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_PlaylistItem.class, "etag"));
    }

    public Object setId(RuntimeEnv env, Object... args) {
        Object id = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_PlaylistItem.class, "id", id);

        return null;
    }

    public Object getId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_PlaylistItem.class, "id"));
    }
