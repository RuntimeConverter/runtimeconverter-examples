...
public class Google_Bookshelves extends Google_Model implements RuntimeFileContextInterface {

    public Object __itemsType = "Google_Bookshelf";
    ...
    public Google_Bookshelves(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "__itemsType":
                if (Google_Bookshelves.class.isAssignableFrom(caller)) {
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_Bookshelves.class,
                items,
                "Google_Bookshelf",
                "setItems");
        ZVal.setProperty(this, Google_Bookshelves.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Bookshelves.class, "items"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Bookshelves.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Bookshelves.class, "kind"));
    }
