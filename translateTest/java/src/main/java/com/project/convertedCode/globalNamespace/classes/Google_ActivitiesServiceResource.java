...
import com.project.convertedCode.globalNamespace.classes.Google_ActivityFeed;
import com.runtimeconverter.runtime.modules.standard.CRArrayF;
import com.runtimeconverter.runtime.classes.RuntimeClassBase;
import com.runtimeconverter.runtime.RuntimeEnv;
import com.project.convertedCode.globalNamespace.classes.Google_Activity;
...
public class Google_ActivitiesServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_ActivitiesServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listActivities":
                return this.listActivities(env, args);
            case "get":
    ...
    public Object search(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_ActivitiesServiceResource.class,
                        "search",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_ActivitiesServiceResource.class))) {
            return ZVal.assign(new Google_ActivityFeed(env, data));
    ...
    public Object listActivities(RuntimeEnv env, Object... args) {
        ...
        Object data = null;
        Object params = null;
        params = ZVal.newArray(new ZPair("userId", userId), new ZPair("collection", collection));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
    ...
    public Object get(RuntimeEnv env, Object... args) {
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_ActivitiesServiceResource.class))) {
            return ZVal.assign(new Google_Activity(env, data));
