...
public class Google_BucketAccessControls extends Google_Model
        implements RuntimeFileContextInterface {

    public Object __itemsType = "Google_BucketAccessControl";
    ...
    public Google_BucketAccessControls(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "__itemsType":
                if (Google_BucketAccessControls.class.isAssignableFrom(caller)) {
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_BucketAccessControls.class,
                items,
                "Google_BucketAccessControl",
                "setItems");
        ZVal.setProperty(this, Google_BucketAccessControls.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BucketAccessControls.class, "items"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_BucketAccessControls.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BucketAccessControls.class, "kind"));
    }
