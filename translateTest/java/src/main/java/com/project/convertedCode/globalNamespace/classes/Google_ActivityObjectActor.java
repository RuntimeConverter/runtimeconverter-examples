...
public class Google_ActivityObjectActor extends Google_Model
        implements RuntimeFileContextInterface {

    public Object url = null;

    public Object __imageType = "Google_ActivityObjectActorImage";
    ...
    public Google_ActivityObjectActor(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "url":
                return this.url;
            case "__imageType":
                if (Google_ActivityObjectActor.class.isAssignableFrom(caller)) {
    ...
    public Object setUrl(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_ActivityObjectActor.class, "url", url);

        return null;
    }

    public Object getUrl(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ActivityObjectActor.class, "url"));
    }

    public Object setImage(RuntimeEnv env, Object... args) {
        Object image = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_ActivityObjectActor.class, "image", image);

        return null;
    }

    public Object getImage(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ActivityObjectActor.class, "image"));
    }

    public Object setDisplayName(RuntimeEnv env, Object... args) {
        Object displayName = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_ActivityObjectActor.class, "displayName", displayName);

        return null;
    }

    public Object getDisplayName(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ActivityObjectActor.class, "displayName"));
    }

    public Object setId(RuntimeEnv env, Object... args) {
        Object id = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_ActivityObjectActor.class, "id", id);

        return null;
    }

    public Object getId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ActivityObjectActor.class, "id"));
    }
