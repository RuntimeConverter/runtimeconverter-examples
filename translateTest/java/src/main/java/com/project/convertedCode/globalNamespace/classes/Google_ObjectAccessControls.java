...
public class Google_ObjectAccessControls extends Google_Model
        implements RuntimeFileContextInterface {

    public Object __itemsType = "Google_ObjectAccessControl";
    ...
    public Google_ObjectAccessControls(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "__itemsType":
                if (Google_ObjectAccessControls.class.isAssignableFrom(caller)) {
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_ObjectAccessControls.class,
                items,
                "Google_ObjectAccessControl",
                "setItems");
        ZVal.setProperty(this, Google_ObjectAccessControls.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ObjectAccessControls.class, "items"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_ObjectAccessControls.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ObjectAccessControls.class, "kind"));
    }
