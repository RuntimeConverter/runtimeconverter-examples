...
public class Google_SeriesRulesVotes extends Google_Model implements RuntimeFileContextInterface {

    public Object close = null;

    public Object open = null;

    public Google_SeriesRulesVotes(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setClose(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_SeriesRulesVotes.class, "close", close);

        return null;
    }

    public Object getClose(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SeriesRulesVotes.class, "close"));
    }

    public Object setOpen(RuntimeEnv env, Object... args) {
        Object open = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_SeriesRulesVotes.class, "open", open);

        return null;
    }

    public Object getOpen(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SeriesRulesVotes.class, "open"));
    }
