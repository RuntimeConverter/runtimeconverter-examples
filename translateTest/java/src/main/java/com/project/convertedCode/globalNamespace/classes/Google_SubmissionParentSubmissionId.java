...
public class Google_SubmissionParentSubmissionId extends Google_Model
    ...
    public Google_SubmissionParentSubmissionId(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setSeriesId(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_SubmissionParentSubmissionId.class, "seriesId", seriesId);
    ...
    public Object getSeriesId(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_SubmissionParentSubmissionId.class, "seriesId"));
    }

    public Object setSubmissionId(RuntimeEnv env, Object... args) {
        Object submissionId = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(
                this, Google_SubmissionParentSubmissionId.class, "submissionId", submissionId);
    ...
    public Object getSubmissionId(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_SubmissionParentSubmissionId.class, "submissionId"));
    }
