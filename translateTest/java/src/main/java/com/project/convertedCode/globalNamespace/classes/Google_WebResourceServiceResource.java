...
import com.project.convertedCode.globalNamespace.classes.Google_SiteVerificationWebResourceListResponse;
import com.project.convertedCode.globalNamespace.classes.Google_ServiceResource;
import com.runtimeconverter.runtime.passByReference.PassByReferenceArgs;
import com.runtimeconverter.runtime.includes.RuntimeFileContextInterface;
import com.runtimeconverter.runtime.modules.standard.CRArrayF;
import com.project.convertedCode.globalNamespace.classes.Google_SiteVerificationWebResourceGettokenResponse;
import com.runtimeconverter.runtime.classes.RuntimeClassBase;
import com.runtimeconverter.runtime.RuntimeEnv;
import com.project.convertedCode.globalNamespace.classes.Google_SiteVerificationWebResourceResource;
...
public class Google_WebResourceServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_WebResourceServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listWebResource":
                return this.listWebResource(env, args);
            case "update":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        params =
                ZVal.newArray(
                        new ZPair("verificationMethod", verificationMethod),
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_WebResourceServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_WebResourceServiceResource.class))) {
            return ZVal.assign(new Google_SiteVerificationWebResourceResource(env, data));
    ...
    public Object listWebResource(RuntimeEnv env, Object... args) {
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_WebResourceServiceResource.class))) {
            return ZVal.assign(new Google_SiteVerificationWebResourceListResponse(env, data));
    ...
    public Object update(RuntimeEnv env, Object... args) {
        ...
        Object data = null;
        Object params = null;
        params = ZVal.newArray(new ZPair("id", id), new ZPair("postBody", postBody));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
    ...
    public Object getToken(RuntimeEnv env, Object... args) {
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_WebResourceServiceResource.class))) {
            return ZVal.assign(new Google_SiteVerificationWebResourceGettokenResponse(env, data));
