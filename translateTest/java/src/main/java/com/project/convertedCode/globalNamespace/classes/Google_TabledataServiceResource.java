...
import com.project.convertedCode.globalNamespace.classes.Google_TableDataList;
...
public class Google_TabledataServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_TabledataServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            case "listTabledata":
                return this.listTabledata(env, args);
        }
    ...
    public Object listTabledata(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_TabledataServiceResource.class,
                        "list",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_TabledataServiceResource.class))) {
            return ZVal.assign(new Google_TableDataList(env, data));
