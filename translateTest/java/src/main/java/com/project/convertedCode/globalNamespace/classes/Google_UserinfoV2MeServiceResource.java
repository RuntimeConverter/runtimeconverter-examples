...
import com.project.convertedCode.globalNamespace.classes.Google_Userinfo;
...
public class Google_UserinfoV2MeServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_UserinfoV2MeServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object get(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_UserinfoV2MeServiceResource.class,
                        "get",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_UserinfoV2MeServiceResource.class))) {
            return ZVal.assign(new Google_Userinfo(env, data));
