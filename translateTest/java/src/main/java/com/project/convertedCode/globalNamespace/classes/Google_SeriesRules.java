...
public class Google_SeriesRules extends Google_Model implements RuntimeFileContextInterface {

    public Object __votesType = "Google_SeriesRulesVotes";

    public Object __votesDataType = "";

    public Object votes = null;

    public Object __submissionsType = "Google_SeriesRulesSubmissions";

    public Object __submissionsDataType = "";

    public Object submissions = null;

    public Google_SeriesRules(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "__votesType":
                if (Google_SeriesRules.class.isAssignableFrom(caller)) {
    ...
    public Object setVotes(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_SeriesRules.class, "votes", votes);

        return null;
    }

    public Object getVotes(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SeriesRules.class, "votes"));
    }

    public Object setSubmissions(RuntimeEnv env, Object... args) {
        Object submissions = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_SeriesRules.class, "submissions", submissions);

        return null;
    }

    public Object getSubmissions(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SeriesRules.class, "submissions"));
    }
