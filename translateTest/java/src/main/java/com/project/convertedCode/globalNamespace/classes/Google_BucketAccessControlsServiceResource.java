...
import com.project.convertedCode.globalNamespace.classes.Google_BucketAccessControls;
...
import com.project.convertedCode.globalNamespace.classes.Google_BucketAccessControl;
...
public class Google_BucketAccessControlsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_BucketAccessControlsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listBucketAccessControls":
                return this.listBucketAccessControls(env, args);
            case "update":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_BucketAccessControlsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(
                        this, "useObjects", Google_BucketAccessControlsServiceResource.class))) {
            return ZVal.assign(new Google_BucketAccessControl(env, data));
    ...
    public Object get(RuntimeEnv env, Object... args) {
        Object bucket = ZVal.assignParameter(args, 0, null);
        Object entity = ZVal.assignParameter(args, 1, null);
        Object optParams = ZVal.assignParameter(args, 2, null);
        if (ZVal.isNull(optParams)) {
            optParams = ZVal.newArray();
        }
        Object data = null;
        Object params = null;
        params = ZVal.newArray(new ZPair("bucket", bucket), new ZPair("entity", entity));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
    ...
    public Object listBucketAccessControls(RuntimeEnv env, Object... args) {
        Object bucket = ZVal.assignParameter(args, 0, null);
        ...
        if (ZVal.isTrue(
                env.callMethod(
                        this, "useObjects", Google_BucketAccessControlsServiceResource.class))) {
            return ZVal.assign(new Google_BucketAccessControls(env, data));
