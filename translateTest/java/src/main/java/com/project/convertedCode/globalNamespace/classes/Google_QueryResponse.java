...
public class Google_QueryResponse extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_QueryResponse(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "kind":
                return this.kind;
            case "__rowsType":
                if (Google_QueryResponse.class.isAssignableFrom(caller)) {
    ...
    public Object setKind(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_QueryResponse.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_QueryResponse.class, "kind"));
    }
    ...
    public Object setRows(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_QueryResponse.class,
                rows,
                "Google_TableRow",
                "setRows");
        ZVal.setProperty(this, Google_QueryResponse.class, "rows", rows);

        return null;
    }

    public Object getRows(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_QueryResponse.class, "rows"));
    }

    public Object setJobReference(RuntimeEnv env, Object... args) {
        Object jobReference = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_QueryResponse.class, "jobReference", jobReference);

        return null;
    }

    public Object getJobReference(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_QueryResponse.class, "jobReference"));
    }

    public Object setJobComplete(RuntimeEnv env, Object... args) {
        Object jobComplete = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_QueryResponse.class, "jobComplete", jobComplete);

        return null;
    }

    public Object getJobComplete(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_QueryResponse.class, "jobComplete"));
    }

    public Object setTotalRows(RuntimeEnv env, Object... args) {
        Object totalRows = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_QueryResponse.class, "totalRows", totalRows);

        return null;
    }

    public Object getTotalRows(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_QueryResponse.class, "totalRows"));
    }

    public Object setSchema(RuntimeEnv env, Object... args) {
        Object schema = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_QueryResponse.class, "schema", schema);

        return null;
    }

    public Object getSchema(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_QueryResponse.class, "schema"));
    }
