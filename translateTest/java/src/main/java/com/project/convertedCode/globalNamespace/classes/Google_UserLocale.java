...
public class Google_UserLocale extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_UserLocale(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setCountry(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_UserLocale.class, "country", country);

        return null;
    }

    public Object getCountry(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_UserLocale.class, "country"));
    }

    public Object setVariant(RuntimeEnv env, Object... args) {
        Object variant = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_UserLocale.class, "variant", variant);

        return null;
    }

    public Object getVariant(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_UserLocale.class, "variant"));
    }

    public Object setLanguage(RuntimeEnv env, Object... args) {
        Object language = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_UserLocale.class, "language", language);

        return null;
    }

    public Object getLanguage(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_UserLocale.class, "language"));
    }
