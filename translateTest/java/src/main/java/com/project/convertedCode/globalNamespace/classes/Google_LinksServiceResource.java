...
import com.project.convertedCode.globalNamespace.classes.Google_Links;
import com.project.convertedCode.globalNamespace.classes.Google_Link;
...
public class Google_LinksServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_LinksServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listLinks":
                return this.listLinks(env, args);
            case "get":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_LinksServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_LinksServiceResource.class))) {
            return ZVal.assign(new Google_Link(env, data));
    ...
    public Object listLinks(RuntimeEnv env, Object... args) {
        Object role = ZVal.assignParameter(args, 0, null);
        Object roleId = ZVal.assignParameter(args, 1, null);
        ...
        data =
                env.callMethod(
                        ...
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_LinksServiceResource.class))) {
            return ZVal.assign(new Google_Links(env, data));
    ...
    public Object get(RuntimeEnv env, Object... args) {
        Object role = ZVal.assignParameter(args, 0, null);
        Object roleId = ZVal.assignParameter(args, 1, null);
        Object linkId = ZVal.assignParameter(args, 2, null);
        Object optParams = ZVal.assignParameter(args, 3, null);
        if (ZVal.isNull(optParams)) {
            optParams = ZVal.newArray();
        }
