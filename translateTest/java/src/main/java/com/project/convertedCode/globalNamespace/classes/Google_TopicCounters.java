...
public class Google_TopicCounters extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_TopicCounters(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setUsers(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_TopicCounters.class, "users", users);

        return null;
    }

    public Object getUsers(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TopicCounters.class, "users"));
    }

    public Object setNoneVotes(RuntimeEnv env, Object... args) {
        Object noneVotes = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_TopicCounters.class, "noneVotes", noneVotes);

        return null;
    }

    public Object getNoneVotes(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TopicCounters.class, "noneVotes"));
    }

    public Object setVideoSubmissions(RuntimeEnv env, Object... args) {
        Object videoSubmissions = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_TopicCounters.class, "videoSubmissions", videoSubmissions);

        return null;
    }

    public Object getVideoSubmissions(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TopicCounters.class, "videoSubmissions"));
    }

    public Object setMinusVotes(RuntimeEnv env, Object... args) {
        Object minusVotes = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_TopicCounters.class, "minusVotes", minusVotes);

        return null;
    }

    public Object getMinusVotes(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TopicCounters.class, "minusVotes"));
    }

    public Object setSubmissions(RuntimeEnv env, Object... args) {
        Object submissions = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_TopicCounters.class, "submissions", submissions);

        return null;
    }

    public Object getSubmissions(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TopicCounters.class, "submissions"));
    }

    public Object setPlusVotes(RuntimeEnv env, Object... args) {
        Object plusVotes = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_TopicCounters.class, "plusVotes", plusVotes);

        return null;
    }

    public Object getPlusVotes(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TopicCounters.class, "plusVotes"));
    }
