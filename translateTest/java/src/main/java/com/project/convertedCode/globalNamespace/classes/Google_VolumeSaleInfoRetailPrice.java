...
public class Google_VolumeSaleInfoRetailPrice extends Google_Model
    ...
    public Google_VolumeSaleInfoRetailPrice(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setAmount(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_VolumeSaleInfoRetailPrice.class, "amount", amount);
    ...
    public Object getAmount(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_VolumeSaleInfoRetailPrice.class, "amount"));
    }

    public Object setCurrencyCode(RuntimeEnv env, Object... args) {
        Object currencyCode = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(
                this, Google_VolumeSaleInfoRetailPrice.class, "currencyCode", currencyCode);
    ...
    public Object getCurrencyCode(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_VolumeSaleInfoRetailPrice.class, "currencyCode"));
    }
