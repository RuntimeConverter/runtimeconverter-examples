...
public class Google_BlogPosts extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_BlogPosts(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            ...
            case "__itemsType":
                if (Google_BlogPosts.class.isAssignableFrom(caller)) {
    ...
    public Object setTotalItems(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_BlogPosts.class, "totalItems", totalItems);

        return null;
    }

    public Object getTotalItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BlogPosts.class, "totalItems"));
    }

    public Object setItems(RuntimeEnv env, Object... args) {
        Object items = ZVal.assignParameter(args, 0, null);
        env.callMethod(
                this, "assertIsArray", Google_BlogPosts.class, items, "Google_Post", "setItems");
        ZVal.setProperty(this, Google_BlogPosts.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BlogPosts.class, "items"));
    }

    public Object setSelfLink(RuntimeEnv env, Object... args) {
        Object selfLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_BlogPosts.class, "selfLink", selfLink);

        return null;
    }

    public Object getSelfLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BlogPosts.class, "selfLink"));
    }
