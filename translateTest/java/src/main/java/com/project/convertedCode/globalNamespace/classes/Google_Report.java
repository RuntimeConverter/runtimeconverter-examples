...
public class Google_Report extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Object __headersType = "Google_ReportHeaders";
    ...
    public Google_Report(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            ...
            case "totals":
                return this.totals;
            case "__headersType":
                if (Google_Report.class.isAssignableFrom(caller)) {
    ...
    public Object setKind(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_Report.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Report.class, "kind"));
    }

    public Object setRows(RuntimeEnv env, Object... args) {
        Object rows = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Report.class, "rows", rows);

        return null;
    }

    public Object getRows(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Report.class, "rows"));
    }

    public Object setWarnings(RuntimeEnv env, Object... args) {
        Object warnings = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Report.class, "warnings", warnings);

        return null;
    }

    public Object getWarnings(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Report.class, "warnings"));
    }

    public Object setTotals(RuntimeEnv env, Object... args) {
        Object totals = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Report.class, "totals", totals);

        return null;
    }

    public Object getTotals(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Report.class, "totals"));
    }
    ...
    public Object setHeaders(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                ...
                "setHeaders");
        ZVal.setProperty(this, Google_Report.class, "headers", headers);

        return null;
    }

    public Object getHeaders(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Report.class, "headers"));
    }

    public Object setTotalMatchedRows(RuntimeEnv env, Object... args) {
        Object totalMatchedRows = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Report.class, "totalMatchedRows", totalMatchedRows);

        return null;
    }

    public Object getTotalMatchedRows(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Report.class, "totalMatchedRows"));
    }

    public Object setAverages(RuntimeEnv env, Object... args) {
        Object averages = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Report.class, "averages", averages);

        return null;
    }

    public Object getAverages(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Report.class, "averages"));
    }
