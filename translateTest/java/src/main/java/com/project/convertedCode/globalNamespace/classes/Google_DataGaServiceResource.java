...
import com.project.convertedCode.globalNamespace.classes.Google_GaData;
...
public class Google_DataGaServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_DataGaServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object get(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_DataGaServiceResource.class,
                        "get",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_DataGaServiceResource.class))) {
            return ZVal.assign(new Google_GaData(env, data));
