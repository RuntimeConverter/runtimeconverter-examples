...
public class Google_ScrapsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_ScrapsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_ScrapsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_ScrapsServiceResource.class))) {
