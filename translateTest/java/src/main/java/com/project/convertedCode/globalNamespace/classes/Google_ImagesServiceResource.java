...
import com.project.convertedCode.globalNamespace.classes.Google_Image;
...
import com.project.convertedCode.globalNamespace.classes.Google_ImageList;
...
public class Google_ImagesServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_ImagesServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listImages":
                return this.listImages(env, args);
            case "delete":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_ImagesServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_ImagesServiceResource.class))) {
    ...
    public Object get(RuntimeEnv env, Object... args) {
        Object project = ZVal.assignParameter(args, 0, null);
        Object image = ZVal.assignParameter(args, 1, null);
        Object optParams = ZVal.assignParameter(args, 2, null);
        if (ZVal.isNull(optParams)) {
            optParams = ZVal.newArray();
        }
        Object data = null;
        Object params = null;
        params = ZVal.newArray(new ZPair("project", project), new ZPair("image", image));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
                        ...
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_ImagesServiceResource.class))) {
            return ZVal.assign(new Google_Image(env, data));
    ...
    public Object listImages(RuntimeEnv env, Object... args) {
        Object project = ZVal.assignParameter(args, 0, null);
        ...
        data =
                env.callMethod(
                        ...
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_ImagesServiceResource.class))) {
            return ZVal.assign(new Google_ImageList(env, data));
