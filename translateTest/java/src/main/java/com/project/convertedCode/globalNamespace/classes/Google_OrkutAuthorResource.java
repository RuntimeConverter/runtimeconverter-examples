...
public class Google_OrkutAuthorResource extends Google_Model
        implements RuntimeFileContextInterface {

    public Object url = null;

    public Object __imageType = "Google_OrkutAuthorResourceImage";
    ...
    public Google_OrkutAuthorResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            case "url":
                return this.url;
            case "__imageType":
                if (Google_OrkutAuthorResource.class.isAssignableFrom(caller)) {
    ...
    public Object setUrl(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_OrkutAuthorResource.class, "url", url);

        return null;
    }

    public Object getUrl(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_OrkutAuthorResource.class, "url"));
    }

    public Object setImage(RuntimeEnv env, Object... args) {
        Object image = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_OrkutAuthorResource.class, "image", image);

        return null;
    }

    public Object getImage(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_OrkutAuthorResource.class, "image"));
    }

    public Object setDisplayName(RuntimeEnv env, Object... args) {
        Object displayName = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_OrkutAuthorResource.class, "displayName", displayName);

        return null;
    }

    public Object getDisplayName(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_OrkutAuthorResource.class, "displayName"));
    }

    public Object setId(RuntimeEnv env, Object... args) {
        Object id = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_OrkutAuthorResource.class, "id", id);

        return null;
    }

    public Object getId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_OrkutAuthorResource.class, "id"));
    }
