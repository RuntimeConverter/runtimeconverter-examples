...
public class Google_CommunityMembersList extends Google_Model
    ...
    public Object __itemsType = "Google_CommunityMembers";
    ...
    public Google_CommunityMembersList(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            ...
            case "kind":
                return this.kind;
            case "__itemsType":
                if (Google_CommunityMembersList.class.isAssignableFrom(caller)) {
    ...
    public Object setNextPageToken(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_CommunityMembersList.class, "nextPageToken", nextPageToken);
    ...
    public Object getNextPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_CommunityMembersList.class, "nextPageToken"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CommunityMembersList.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CommunityMembersList.class, "kind"));
    }
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_CommunityMembersList.class,
                items,
                "Google_CommunityMembers",
                "setItems");
        ZVal.setProperty(this, Google_CommunityMembersList.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CommunityMembersList.class, "items"));
    }

    public Object setPrevPageToken(RuntimeEnv env, Object... args) {
        Object prevPageToken = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CommunityMembersList.class, "prevPageToken", prevPageToken);
    ...
    public Object getPrevPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_CommunityMembersList.class, "prevPageToken"));
    }

    public Object setLastPageToken(RuntimeEnv env, Object... args) {
        Object lastPageToken = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CommunityMembersList.class, "lastPageToken", lastPageToken);
    ...
    public Object getLastPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_CommunityMembersList.class, "lastPageToken"));
    }

    public Object setFirstPageToken(RuntimeEnv env, Object... args) {
        Object firstPageToken = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CommunityMembersList.class, "firstPageToken", firstPageToken);
    ...
    public Object getFirstPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_CommunityMembersList.class, "firstPageToken"));
    }
