...
public class Google_AclServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_AclServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object delete(RuntimeEnv env, Object... args) {
        ...
        Object data = null;
        Object params = null;
        params = ZVal.newArray(new ZPair("activityId", activityId), new ZPair("userId", userId));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_AclServiceResource.class,
                        "delete",
