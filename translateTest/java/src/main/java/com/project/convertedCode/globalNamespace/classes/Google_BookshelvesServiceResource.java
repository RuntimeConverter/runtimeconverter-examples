...
public class Google_BookshelvesServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_BookshelvesServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
            ...
            Object... args) {
        switch (method) {
            case "listBookshelves":
                return this.listBookshelves(env, args);
            case "get":
    ...
    public Object listBookshelves(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_BookshelvesServiceResource.class,
                        "list",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_BookshelvesServiceResource.class))) {
