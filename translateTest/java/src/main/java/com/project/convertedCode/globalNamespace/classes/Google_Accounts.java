...
public class Google_Accounts extends Google_Model implements RuntimeFileContextInterface {

    public Object username = null;

    public Object kind = null;

    public Object __itemsType = "Google_Account";
    ...
    public Google_Accounts(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            ...
            case "kind":
                return this.kind;
            case "__itemsType":
                if (Google_Accounts.class.isAssignableFrom(caller)) {
    ...
    public Object setUsername(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_Accounts.class, "username", username);

        return null;
    }

    public Object getUsername(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Accounts.class, "username"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Accounts.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Accounts.class, "kind"));
    }

    public Object setItems(RuntimeEnv env, Object... args) {
        Object items = ZVal.assignParameter(args, 0, null);
        env.callMethod(
                this, "assertIsArray", Google_Accounts.class, items, "Google_Account", "setItems");
        ZVal.setProperty(this, Google_Accounts.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Accounts.class, "items"));
    }

    public Object setItemsPerPage(RuntimeEnv env, Object... args) {
        Object itemsPerPage = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Accounts.class, "itemsPerPage", itemsPerPage);

        return null;
    }

    public Object getItemsPerPage(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Accounts.class, "itemsPerPage"));
    }

    public Object setPreviousLink(RuntimeEnv env, Object... args) {
        Object previousLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Accounts.class, "previousLink", previousLink);

        return null;
    }

    public Object getPreviousLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Accounts.class, "previousLink"));
    }

    public Object setStartIndex(RuntimeEnv env, Object... args) {
        Object startIndex = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Accounts.class, "startIndex", startIndex);

        return null;
    }

    public Object getStartIndex(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Accounts.class, "startIndex"));
    }

    public Object setNextLink(RuntimeEnv env, Object... args) {
        Object nextLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Accounts.class, "nextLink", nextLink);

        return null;
    }

    public Object getNextLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Accounts.class, "nextLink"));
    }

    public Object setTotalResults(RuntimeEnv env, Object... args) {
        Object totalResults = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_Accounts.class, "totalResults", totalResults);

        return null;
    }

    public Object getTotalResults(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_Accounts.class, "totalResults"));
    }
