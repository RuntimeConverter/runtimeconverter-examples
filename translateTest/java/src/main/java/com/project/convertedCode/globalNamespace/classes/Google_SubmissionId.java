...
public class Google_SubmissionId extends Google_Model implements RuntimeFileContextInterface {

    public Object seriesId = null;

    public Object submissionId = null;

    public Google_SubmissionId(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setSeriesId(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_SubmissionId.class, "seriesId", seriesId);

        return null;
    }

    public Object getSeriesId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SubmissionId.class, "seriesId"));
    }

    public Object setSubmissionId(RuntimeEnv env, Object... args) {
        Object submissionId = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_SubmissionId.class, "submissionId", submissionId);

        return null;
    }

    public Object getSubmissionId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SubmissionId.class, "submissionId"));
    }
