...
import com.project.convertedCode.globalNamespace.classes.Google_CommunityPollVote;
...
public class Google_CommunityPollVotesServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_CommunityPollVotesServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_CommunityPollVotesServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(
                        this, "useObjects", Google_CommunityPollVotesServiceResource.class))) {
            return ZVal.assign(new Google_CommunityPollVote(env, data));
