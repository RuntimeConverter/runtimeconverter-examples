...
public class Google_EventOrganizer extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_EventOrganizer(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setSelf(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_EventOrganizer.class, "self", self);

        return null;
    }

    public Object getSelf(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_EventOrganizer.class, "self"));
    }

    public Object setDisplayName(RuntimeEnv env, Object... args) {
        Object displayName = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_EventOrganizer.class, "displayName", displayName);

        return null;
    }

    public Object getDisplayName(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_EventOrganizer.class, "displayName"));
    }

    public Object setEmail(RuntimeEnv env, Object... args) {
        Object email = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_EventOrganizer.class, "email", email);

        return null;
    }

    public Object getEmail(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_EventOrganizer.class, "email"));
    }

    public Object setId(RuntimeEnv env, Object... args) {
        Object id = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_EventOrganizer.class, "id", id);

        return null;
    }

    public Object getId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_EventOrganizer.class, "id"));
    }
