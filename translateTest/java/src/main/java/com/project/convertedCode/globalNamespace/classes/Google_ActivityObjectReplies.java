...
public class Google_ActivityObjectReplies extends Google_Model
    ...
    public Google_ActivityObjectReplies(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setTotalItems(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_ActivityObjectReplies.class, "totalItems", totalItems);
    ...
    public Object getTotalItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_ActivityObjectReplies.class, "totalItems"));
    }

    public Object setSelfLink(RuntimeEnv env, Object... args) {
        Object selfLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_ActivityObjectReplies.class, "selfLink", selfLink);

        return null;
    }

    public Object getSelfLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ActivityObjectReplies.class, "selfLink"));
    }
