...
import com.project.convertedCode.globalNamespace.classes.Google_Dataset;
import com.runtimeconverter.runtime.includes.RuntimeFileContextInterface;
import com.project.convertedCode.globalNamespace.classes.Google_DatasetList;
...
public class Google_DatasetsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_DatasetsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listDatasets":
                return this.listDatasets(env, args);
            case "update":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_DatasetsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_DatasetsServiceResource.class))) {
            return ZVal.assign(new Google_Dataset(env, data));
    ...
    public Object listDatasets(RuntimeEnv env, Object... args) {
        Object projectId = ZVal.assignParameter(args, 0, null);
        ...
        data =
                env.callMethod(
                        ...
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_DatasetsServiceResource.class))) {
            return ZVal.assign(new Google_DatasetList(env, data));
