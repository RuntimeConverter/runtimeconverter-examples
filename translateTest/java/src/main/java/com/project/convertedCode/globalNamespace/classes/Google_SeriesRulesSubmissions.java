...
public class Google_SeriesRulesSubmissions extends Google_Model
    ...
    public Google_SeriesRulesSubmissions(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setClose(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_SeriesRulesSubmissions.class, "close", close);

        return null;
    }

    public Object getClose(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SeriesRulesSubmissions.class, "close"));
    }

    public Object setOpen(RuntimeEnv env, Object... args) {
        Object open = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_SeriesRulesSubmissions.class, "open", open);

        return null;
    }

    public Object getOpen(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_SeriesRulesSubmissions.class, "open"));
    }
