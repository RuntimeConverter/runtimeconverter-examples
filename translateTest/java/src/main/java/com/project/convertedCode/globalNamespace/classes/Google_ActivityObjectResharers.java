...
public class Google_ActivityObjectResharers extends Google_Model
    ...
    public Google_ActivityObjectResharers(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setTotalItems(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_ActivityObjectResharers.class, "totalItems", totalItems);
    ...
    public Object getTotalItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_ActivityObjectResharers.class, "totalItems"));
    }

    public Object setSelfLink(RuntimeEnv env, Object... args) {
        Object selfLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_ActivityObjectResharers.class, "selfLink", selfLink);
    ...
    public Object getSelfLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_ActivityObjectResharers.class, "selfLink"));
    }
