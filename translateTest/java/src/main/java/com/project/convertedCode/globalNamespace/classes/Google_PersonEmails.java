...
public class Google_PersonEmails extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_PersonEmails(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setType(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_PersonEmails.class, "type", type);

        return null;
    }

    public Object getType(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_PersonEmails.class, "type"));
    }

    public Object setPrimary(RuntimeEnv env, Object... args) {
        Object primary = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_PersonEmails.class, "primary", primary);

        return null;
    }

    public Object getPrimary(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_PersonEmails.class, "primary"));
    }

    public Object setValue(RuntimeEnv env, Object... args) {
        Object value = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_PersonEmails.class, "value", value);

        return null;
    }

    public Object getValue(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_PersonEmails.class, "value"));
    }
