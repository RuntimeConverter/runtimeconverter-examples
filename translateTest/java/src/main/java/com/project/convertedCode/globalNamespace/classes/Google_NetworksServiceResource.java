...
import com.project.convertedCode.globalNamespace.classes.Google_Network;
import com.project.convertedCode.globalNamespace.classes.Google_NetworkList;
...
public class Google_NetworksServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_NetworksServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listNetworks":
                return this.listNetworks(env, args);
            case "delete":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_NetworksServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_NetworksServiceResource.class))) {
    ...
    public Object get(RuntimeEnv env, Object... args) {
        Object project = ZVal.assignParameter(args, 0, null);
        Object network = ZVal.assignParameter(args, 1, null);
        Object optParams = ZVal.assignParameter(args, 2, null);
        if (ZVal.isNull(optParams)) {
            optParams = ZVal.newArray();
        }
        Object data = null;
        Object params = null;
        params = ZVal.newArray(new ZPair("project", project), new ZPair("network", network));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
                        ...
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_NetworksServiceResource.class))) {
            return ZVal.assign(new Google_Network(env, data));
    ...
    public Object listNetworks(RuntimeEnv env, Object... args) {
        Object project = ZVal.assignParameter(args, 0, null);
        ...
        data =
                env.callMethod(
                        ...
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_NetworksServiceResource.class))) {
            return ZVal.assign(new Google_NetworkList(env, data));
