...
public class Google_AboutExportFormats extends Google_Model implements RuntimeFileContextInterface {

    public Object source = null;

    public Object targets = null;

    public Google_AboutExportFormats(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setSource(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_AboutExportFormats.class, "source", source);

        return null;
    }

    public Object getSource(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_AboutExportFormats.class, "source"));
    }
    ...
    public Object setTargets(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_AboutExportFormats.class,
                targets,
                "Google_string",
                "setTargets");
        ZVal.setProperty(this, Google_AboutExportFormats.class, "targets", targets);

        return null;
    }

    public Object getTargets(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_AboutExportFormats.class, "targets"));
    }
