...
import com.project.convertedCode.globalNamespace.classes.Google_ParentList;
...
import com.project.convertedCode.globalNamespace.classes.Google_ParentReference;
...
public class Google_ParentsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_ParentsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listParents":
                return this.listParents(env, args);
            case "delete":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_ParentsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_ParentsServiceResource.class))) {
            return ZVal.assign(new Google_ParentReference(env, data));
    ...
    public Object get(RuntimeEnv env, Object... args) {
        Object fileId = ZVal.assignParameter(args, 0, null);
        Object parentId = ZVal.assignParameter(args, 1, null);
        Object optParams = ZVal.assignParameter(args, 2, null);
        if (ZVal.isNull(optParams)) {
            optParams = ZVal.newArray();
        }
        Object data = null;
        Object params = null;
        params = ZVal.newArray(new ZPair("fileId", fileId), new ZPair("parentId", parentId));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
    ...
    public Object listParents(RuntimeEnv env, Object... args) {
        Object fileId = ZVal.assignParameter(args, 0, null);
        ...
        data =
                env.callMethod(
                        ...
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_ParentsServiceResource.class))) {
            return ZVal.assign(new Google_ParentList(env, data));
