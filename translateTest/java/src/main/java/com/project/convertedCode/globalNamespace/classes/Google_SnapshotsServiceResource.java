...
import com.project.convertedCode.globalNamespace.classes.Google_SnapshotList;
import com.runtimeconverter.runtime.includes.RuntimeFileContextInterface;
import com.project.convertedCode.globalNamespace.classes.Google_Snapshot;
...
public class Google_SnapshotsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_SnapshotsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listSnapshots":
                return this.listSnapshots(env, args);
            case "delete":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_SnapshotsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_SnapshotsServiceResource.class))) {
    ...
    public Object get(RuntimeEnv env, Object... args) {
        Object project = ZVal.assignParameter(args, 0, null);
        Object snapshot = ZVal.assignParameter(args, 1, null);
        Object optParams = ZVal.assignParameter(args, 2, null);
        if (ZVal.isNull(optParams)) {
            optParams = ZVal.newArray();
        }
        Object data = null;
        Object params = null;
        params = ZVal.newArray(new ZPair("project", project), new ZPair("snapshot", snapshot));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_SnapshotsServiceResource.class))) {
            return ZVal.assign(new Google_Snapshot(env, data));
    ...
    public Object listSnapshots(RuntimeEnv env, Object... args) {
        Object project = ZVal.assignParameter(args, 0, null);
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_SnapshotsServiceResource.class))) {
            return ZVal.assign(new Google_SnapshotList(env, data));
