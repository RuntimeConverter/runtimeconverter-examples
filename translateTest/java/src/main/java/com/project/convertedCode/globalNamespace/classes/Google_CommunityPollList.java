...
public class Google_CommunityPollList extends Google_Model implements RuntimeFileContextInterface {

    public Object nextPageToken = null;

    public Object kind = null;

    public Object __itemsType = "Google_CommunityPoll";
    ...
    public Google_CommunityPollList(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            ...
            case "kind":
                return this.kind;
            case "__itemsType":
                if (Google_CommunityPollList.class.isAssignableFrom(caller)) {
    ...
    public Object setNextPageToken(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_CommunityPollList.class, "nextPageToken", nextPageToken);

        return null;
    }

    public Object getNextPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CommunityPollList.class, "nextPageToken"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CommunityPollList.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CommunityPollList.class, "kind"));
    }
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_CommunityPollList.class,
                items,
                "Google_CommunityPoll",
                "setItems");
        ZVal.setProperty(this, Google_CommunityPollList.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CommunityPollList.class, "items"));
    }

    public Object setPrevPageToken(RuntimeEnv env, Object... args) {
        Object prevPageToken = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CommunityPollList.class, "prevPageToken", prevPageToken);

        return null;
    }

    public Object getPrevPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CommunityPollList.class, "prevPageToken"));
    }

    public Object setLastPageToken(RuntimeEnv env, Object... args) {
        Object lastPageToken = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CommunityPollList.class, "lastPageToken", lastPageToken);

        return null;
    }

    public Object getLastPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CommunityPollList.class, "lastPageToken"));
    }

    public Object setFirstPageToken(RuntimeEnv env, Object... args) {
        Object firstPageToken = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CommunityPollList.class, "firstPageToken", firstPageToken);
    ...
    public Object getFirstPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_CommunityPollList.class, "firstPageToken"));
    }
