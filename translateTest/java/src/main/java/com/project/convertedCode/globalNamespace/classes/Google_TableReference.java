...
public class Google_TableReference extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_TableReference(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setProjectId(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_TableReference.class, "projectId", projectId);

        return null;
    }

    public Object getProjectId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TableReference.class, "projectId"));
    }

    public Object setTableId(RuntimeEnv env, Object... args) {
        Object tableId = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_TableReference.class, "tableId", tableId);

        return null;
    }

    public Object getTableId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TableReference.class, "tableId"));
    }

    public Object setDatasetId(RuntimeEnv env, Object... args) {
        Object datasetId = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_TableReference.class, "datasetId", datasetId);

        return null;
    }

    public Object getDatasetId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TableReference.class, "datasetId"));
    }
