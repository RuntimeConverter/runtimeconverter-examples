...
public class Google_ReviewAuthor extends Google_Model implements RuntimeFileContextInterface {

    public Object displayName = null;

    public Google_ReviewAuthor(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setDisplayName(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_ReviewAuthor.class, "displayName", displayName);

        return null;
    }

    public Object getDisplayName(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ReviewAuthor.class, "displayName"));
    }
