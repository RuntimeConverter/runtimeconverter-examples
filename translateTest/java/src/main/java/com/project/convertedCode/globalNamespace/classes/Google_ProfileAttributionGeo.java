...
public class Google_ProfileAttributionGeo extends Google_Model
    ...
    public Google_ProfileAttributionGeo(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setLatitude(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_ProfileAttributionGeo.class, "latitude", latitude);

        return null;
    }

    public Object getLatitude(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ProfileAttributionGeo.class, "latitude"));
    }

    public Object setLocation(RuntimeEnv env, Object... args) {
        Object location = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_ProfileAttributionGeo.class, "location", location);

        return null;
    }

    public Object getLocation(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ProfileAttributionGeo.class, "location"));
    }

    public Object setLongitude(RuntimeEnv env, Object... args) {
        Object longitude = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_ProfileAttributionGeo.class, "longitude", longitude);

        return null;
    }

    public Object getLongitude(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_ProfileAttributionGeo.class, "longitude"));
    }
