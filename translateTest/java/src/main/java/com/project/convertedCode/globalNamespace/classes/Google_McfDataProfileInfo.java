...
public class Google_McfDataProfileInfo extends Google_Model implements RuntimeFileContextInterface {
    ...
    public Google_McfDataProfileInfo(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setWebPropertyId(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_McfDataProfileInfo.class, "webPropertyId", webPropertyId);
    ...
    public Object getWebPropertyId(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_McfDataProfileInfo.class, "webPropertyId"));
    }
    ...
    public Object setInternalWebPropertyId(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(
                this,
                Google_McfDataProfileInfo.class,
    ...
    public Object getInternalWebPropertyId(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_McfDataProfileInfo.class, "internalWebPropertyId"));
    }

    public Object setTableId(RuntimeEnv env, Object... args) {
        Object tableId = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_McfDataProfileInfo.class, "tableId", tableId);

        return null;
    }

    public Object getTableId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_McfDataProfileInfo.class, "tableId"));
    }

    public Object setProfileId(RuntimeEnv env, Object... args) {
        Object profileId = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_McfDataProfileInfo.class, "profileId", profileId);

        return null;
    }

    public Object getProfileId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_McfDataProfileInfo.class, "profileId"));
    }

    public Object setProfileName(RuntimeEnv env, Object... args) {
        Object profileName = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_McfDataProfileInfo.class, "profileName", profileName);

        return null;
    }

    public Object getProfileName(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_McfDataProfileInfo.class, "profileName"));
    }

    public Object setAccountId(RuntimeEnv env, Object... args) {
        Object accountId = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_McfDataProfileInfo.class, "accountId", accountId);

        return null;
    }

    public Object getAccountId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_McfDataProfileInfo.class, "accountId"));
    }
