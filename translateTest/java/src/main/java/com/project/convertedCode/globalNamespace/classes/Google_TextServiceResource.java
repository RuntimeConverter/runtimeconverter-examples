...
import com.project.convertedCode.globalNamespace.classes.Google_ContentserviceGet;
...
public class Google_TextServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_TextServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object get(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_TextServiceResource.class,
                        "get",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_TextServiceResource.class))) {
            return ZVal.assign(new Google_ContentserviceGet(env, data));
