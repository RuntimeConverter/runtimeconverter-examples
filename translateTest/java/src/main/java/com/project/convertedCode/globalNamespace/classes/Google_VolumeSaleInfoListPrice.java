...
public class Google_VolumeSaleInfoListPrice extends Google_Model
    ...
    public Google_VolumeSaleInfoListPrice(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setAmount(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_VolumeSaleInfoListPrice.class, "amount", amount);

        return null;
    }

    public Object getAmount(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_VolumeSaleInfoListPrice.class, "amount"));
    }

    public Object setCurrencyCode(RuntimeEnv env, Object... args) {
        Object currencyCode = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_VolumeSaleInfoListPrice.class, "currencyCode", currencyCode);
    ...
    public Object getCurrencyCode(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_VolumeSaleInfoListPrice.class, "currencyCode"));
    }
