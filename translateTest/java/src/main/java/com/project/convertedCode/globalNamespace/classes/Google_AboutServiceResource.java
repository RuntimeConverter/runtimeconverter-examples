...
import com.project.convertedCode.globalNamespace.classes.Google_About;
...
public class Google_AboutServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_AboutServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object get(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_AboutServiceResource.class,
                        "get",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_AboutServiceResource.class))) {
            return ZVal.assign(new Google_About(env, data));
