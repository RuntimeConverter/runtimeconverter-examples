...
import com.project.convertedCode.globalNamespace.classes.Google_Moment;
...
public class Google_MomentsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_MomentsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        params =
                ZVal.newArray(
                        ...
                        new ZPair("collection", collection),
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_MomentsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_MomentsServiceResource.class))) {
            return ZVal.assign(new Google_Moment(env, data));
