...
public class Google_NetworkList extends Google_Model implements RuntimeFileContextInterface {

    public Object nextPageToken = null;

    public Object __itemsType = "Google_Network";
    ...
    public Google_NetworkList(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            ...
            case "__itemsType":
                if (Google_NetworkList.class.isAssignableFrom(caller)) {
    ...
    public Object setNextPageToken(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_NetworkList.class, "nextPageToken", nextPageToken);

        return null;
    }

    public Object getNextPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_NetworkList.class, "nextPageToken"));
    }
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_NetworkList.class,
                items,
                "Google_Network",
                "setItems");
        ZVal.setProperty(this, Google_NetworkList.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_NetworkList.class, "items"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_NetworkList.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_NetworkList.class, "kind"));
    }

    public Object setId(RuntimeEnv env, Object... args) {
        Object id = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_NetworkList.class, "id", id);

        return null;
    }

    public Object getId(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_NetworkList.class, "id"));
    }

    public Object setSelfLink(RuntimeEnv env, Object... args) {
        Object selfLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_NetworkList.class, "selfLink", selfLink);

        return null;
    }

    public Object getSelfLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_NetworkList.class, "selfLink"));
    }
