...
public class Google_UserBlogs extends Google_Model implements RuntimeFileContextInterface {

    public Object selfLink = null;

    public Google_UserBlogs(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setSelfLink(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_UserBlogs.class, "selfLink", selfLink);

        return null;
    }

    public Object getSelfLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_UserBlogs.class, "selfLink"));
    }
