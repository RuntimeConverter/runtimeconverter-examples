...
public class Google_VolumeAccessInfoEpub extends Google_Model
    ...
    public Google_VolumeAccessInfoEpub(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setIsAvailable(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_VolumeAccessInfoEpub.class, "isAvailable", isAvailable);
    ...
    public Object getIsAvailable(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_VolumeAccessInfoEpub.class, "isAvailable"));
    }

    public Object setDownloadLink(RuntimeEnv env, Object... args) {
        Object downloadLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_VolumeAccessInfoEpub.class, "downloadLink", downloadLink);
    ...
    public Object getDownloadLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_VolumeAccessInfoEpub.class, "downloadLink"));
    }

    public Object setAcsTokenLink(RuntimeEnv env, Object... args) {
        Object acsTokenLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_VolumeAccessInfoEpub.class, "acsTokenLink", acsTokenLink);
    ...
    public Object getAcsTokenLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.getProperty(this, Google_VolumeAccessInfoEpub.class, "acsTokenLink"));
    }
