...
import com.project.convertedCode.globalNamespace.classes.Google_TaskList;
import com.runtimeconverter.runtime.includes.RuntimeFileContextInterface;
import com.runtimeconverter.runtime.modules.standard.CRArrayF;
import com.runtimeconverter.runtime.classes.RuntimeClassBase;
import com.runtimeconverter.runtime.RuntimeEnv;
import com.project.convertedCode.globalNamespace.classes.Google_TaskLists;
...
public class Google_TasklistsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_TasklistsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listTasklists":
                return this.listTasklists(env, args);
            case "update":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_TasklistsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_TasklistsServiceResource.class))) {
            return ZVal.assign(new Google_TaskList(env, data));
    ...
    public Object listTasklists(RuntimeEnv env, Object... args) {
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_TasklistsServiceResource.class))) {
            return ZVal.assign(new Google_TaskLists(env, data));
