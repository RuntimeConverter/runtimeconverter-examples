...
import com.project.convertedCode.globalNamespace.classes.Google_FreeBusyResponse;
...
public class Google_FreebusyServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_FreebusyServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object query(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_FreebusyServiceResource.class,
                        "query",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(env.callMethod(this, "useObjects", Google_FreebusyServiceResource.class))) {
            return ZVal.assign(new Google_FreeBusyResponse(env, data));
