...
public class Google_CreativesList extends Google_Model implements RuntimeFileContextInterface {

    public Object nextPageToken = null;

    public Object __itemsType = "Google_Creative";
    ...
    public Google_CreativesList(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object __get(Object key, Class caller) {
        ...
        switch ((String) key) {
            ...
            case "__itemsType":
                if (Google_CreativesList.class.isAssignableFrom(caller)) {
    ...
    public Object setNextPageToken(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_CreativesList.class, "nextPageToken", nextPageToken);

        return null;
    }

    public Object getNextPageToken(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CreativesList.class, "nextPageToken"));
    }
    ...
    public Object setItems(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                this,
                "assertIsArray",
                Google_CreativesList.class,
                items,
                "Google_Creative",
                "setItems");
        ZVal.setProperty(this, Google_CreativesList.class, "items", items);

        return null;
    }

    public Object getItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CreativesList.class, "items"));
    }

    public Object setKind(RuntimeEnv env, Object... args) {
        Object kind = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CreativesList.class, "kind", kind);

        return null;
    }

    public Object getKind(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CreativesList.class, "kind"));
    }
