...
import com.project.convertedCode.globalNamespace.classes.Google_Visibility;
...
public class Google_ActivityVisibilityServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_ActivityVisibilityServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object patch(RuntimeEnv env, Object... args) {
        ...
        Object params = null;
        params =
                ZVal.newArray(new ZPair("activityId", activityId), new ZPair("postBody", postBody));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_ActivityVisibilityServiceResource.class,
                        "patch",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(
                        this, "useObjects", Google_ActivityVisibilityServiceResource.class))) {
            return ZVal.assign(new Google_Visibility(env, data));
