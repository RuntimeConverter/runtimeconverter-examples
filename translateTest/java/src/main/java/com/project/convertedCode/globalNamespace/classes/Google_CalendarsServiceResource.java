...
import com.project.convertedCode.globalNamespace.classes.Google_Calendar;
...
public class Google_CalendarsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_CalendarsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_CalendarsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_CalendarsServiceResource.class))) {
            return ZVal.assign(new Google_Calendar(env, data));
