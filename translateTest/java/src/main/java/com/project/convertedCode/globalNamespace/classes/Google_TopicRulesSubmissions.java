...
public class Google_TopicRulesSubmissions extends Google_Model
    ...
    public Google_TopicRulesSubmissions(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setClose(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_TopicRulesSubmissions.class, "close", close);

        return null;
    }

    public Object getClose(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TopicRulesSubmissions.class, "close"));
    }

    public Object setOpen(RuntimeEnv env, Object... args) {
        Object open = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_TopicRulesSubmissions.class, "open", open);

        return null;
    }

    public Object getOpen(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_TopicRulesSubmissions.class, "open"));
    }
