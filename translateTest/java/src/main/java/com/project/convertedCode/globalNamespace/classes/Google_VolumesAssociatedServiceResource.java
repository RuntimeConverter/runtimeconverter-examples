...
public class Google_VolumesAssociatedServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_VolumesAssociatedServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
            ...
            Object... args) {
        switch (method) {
            case "listVolumesAssociated":
                return this.listVolumesAssociated(env, args);
        }
    ...
    public Object listVolumesAssociated(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_VolumesAssociatedServiceResource.class,
                        "list",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(
                        this, "useObjects", Google_VolumesAssociatedServiceResource.class))) {
