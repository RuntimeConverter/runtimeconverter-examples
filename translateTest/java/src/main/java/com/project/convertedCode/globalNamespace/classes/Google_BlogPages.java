...
public class Google_BlogPages extends Google_Model implements RuntimeFileContextInterface {

    public Object totalItems = null;

    public Object selfLink = null;

    public Google_BlogPages(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setTotalItems(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_BlogPages.class, "totalItems", totalItems);

        return null;
    }

    public Object getTotalItems(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BlogPages.class, "totalItems"));
    }

    public Object setSelfLink(RuntimeEnv env, Object... args) {
        Object selfLink = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_BlogPages.class, "selfLink", selfLink);

        return null;
    }

    public Object getSelfLink(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_BlogPages.class, "selfLink"));
    }
