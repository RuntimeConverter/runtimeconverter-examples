...
public class Google_CcOfferBonusRewards extends Google_Model
    ...
    public Google_CcOfferBonusRewards(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object setAmount(RuntimeEnv env, Object... args) {
        ...
        ZVal.setProperty(this, Google_CcOfferBonusRewards.class, "amount", amount);

        return null;
    }

    public Object getAmount(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CcOfferBonusRewards.class, "amount"));
    }

    public Object setDetails(RuntimeEnv env, Object... args) {
        Object details = ZVal.assignParameter(args, 0, null);
        ZVal.setProperty(this, Google_CcOfferBonusRewards.class, "details", details);

        return null;
    }

    public Object getDetails(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.getProperty(this, Google_CcOfferBonusRewards.class, "details"));
    }
