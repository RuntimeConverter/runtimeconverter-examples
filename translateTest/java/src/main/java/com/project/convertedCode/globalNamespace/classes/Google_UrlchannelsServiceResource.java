...
import com.project.convertedCode.globalNamespace.classes.Google_UrlChannels;
import com.runtimeconverter.runtime.ZVal;
import com.runtimeconverter.runtime.arrays.ZPair;
import com.project.convertedCode.globalNamespace.classes.Google_UrlChannel;
...
public class Google_UrlchannelsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_UrlchannelsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listUrlchannels":
                return this.listUrlchannels(env, args);
            case "delete":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_UrlchannelsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_UrlchannelsServiceResource.class))) {
            return ZVal.assign(new Google_UrlChannel(env, data));
    ...
    public Object listUrlchannels(RuntimeEnv env, Object... args) {
        Object adClientId = ZVal.assignParameter(args, 0, null);
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_UrlchannelsServiceResource.class))) {
            return ZVal.assign(new Google_UrlChannels(env, data));
    ...
    public Object delete(RuntimeEnv env, Object... args) {
        Object adClientId = ZVal.assignParameter(args, 0, null);
        Object urlChannelId = ZVal.assignParameter(args, 1, null);
        Object optParams = ZVal.assignParameter(args, 2, null);
        if (ZVal.isNull(optParams)) {
            optParams = ZVal.newArray();
        }
        ...
        params =
                ZVal.newArray(
                        ...
                        new ZPair("urlChannelId", urlChannelId));
        params = CRArrayF.array_merge.call(env, params, optParams);
        data =
                env.callMethod(
                        this,
