...
import com.project.convertedCode.globalNamespace.classes.Google_AdUnit;
import com.project.convertedCode.globalNamespace.classes.Google_ServiceResource;
import com.runtimeconverter.runtime.passByReference.PassByReferenceArgs;
import com.project.convertedCode.globalNamespace.classes.Google_AdCode;
import com.project.convertedCode.globalNamespace.classes.Google_AdUnits;
...
public class Google_AccountsAdunitsServiceResource extends Google_ServiceResource
        implements RuntimeFileContextInterface {

    public Google_AccountsAdunitsServiceResource(RuntimeEnv env, Object... args) {
        super(env, args);
    ...
    public Object converterRuntimeCallExtended(
        ...
        switch (method) {
            ...
            case "listAccountsAdunits":
                return this.listAccountsAdunits(env, args);
            case "update":
    ...
    public Object insert(RuntimeEnv env, Object... args) {
        ...
        data =
                env.callMethod(
                        this,
                        "__call",
                        Google_AccountsAdunitsServiceResource.class,
                        "insert",
                        ZVal.newArray(new ZPair(0, params)));
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_AccountsAdunitsServiceResource.class))) {
            return ZVal.assign(new Google_AdUnit(env, data));
    ...
    public Object getAdCode(RuntimeEnv env, Object... args) {
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_AccountsAdunitsServiceResource.class))) {
            return ZVal.assign(new Google_AdCode(env, data));
    ...
    public Object listAccountsAdunits(RuntimeEnv env, Object... args) {
        Object accountId = ZVal.assignParameter(args, 0, null);
        Object adClientId = ZVal.assignParameter(args, 1, null);
        ...
        if (ZVal.isTrue(
                env.callMethod(this, "useObjects", Google_AccountsAdunitsServiceResource.class))) {
            return ZVal.assign(new Google_AdUnits(env, data));
