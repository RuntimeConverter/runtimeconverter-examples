...
class Google_Model {
  ...
  /**
   * Verify if $other is an array.
   * @throws Google_Exception Thrown if $other isn't an array.
   * @param array $other Items that should be validated.
   * @param string $type Array items should be of this type.
   * @param string $method Method expecting an array as an argument.
   */
  public function assertIsArray($other, $type, $method) {
